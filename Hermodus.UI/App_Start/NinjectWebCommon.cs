[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Hermodus.UI.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(Hermodus.UI.App_Start.NinjectWebCommon), "Stop")]

namespace Hermodus.UI.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IWatchRepository>().To<EFWatchRespository>();
            kernel.Bind<ICompanyRepository>().To<EFCompanyRespository>();
